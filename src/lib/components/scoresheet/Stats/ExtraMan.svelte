...
<div class="outer">
  ...
  <div class="innerColumn">
    ...
    <div class="innerRow">
      ...
      <input min="0" autocomplete="off" class="field normal" type="number" bind:value={extraMan[side][0].won} />
      <input min="0" autocomplete="off" class="field normal" type="number" bind:value={extraMan[side][0].lost} />
    ...
    <div class="innerRow">
      ...
      <input min="0" autocomplete="off" class="field normal" type="number" bind:value={extraMan[side][1].won} />
      <input min="0" autocomplete="off" class="field normal" type="number" bind:value={extraMan[side][1].lost} />
    ...
    <div class="innerRow">
      ...
      <input min="0" autocomplete="off" class="field normal" type="number" bind:value={extraMan[side][2].won} />
      <input min="0" autocomplete="off" class="field normal" type="number" bind:value={extraMan[side][2].lost} />
    ...
    <div class="innerRow">
      ...
      <input min="0" autocomplete="off" class="field normal" type="number" bind:value={extraMan[side][3].won} />
      <input min="0" autocomplete="off" class="field normal" type="number" bind:value={extraMan[side][3].lost} />
      <div class="rowBox normal">{extraMan[side][3].won}/{extraMan[side][3].lost + extraMan[side][3].won}</div>
    </div>
    <div class="innerRow">
      <div class="rowBox normal">O.T.</div>
      <input min="0" autocomplete="off" class="field normal" type="number" bind:value={extraMan[side][4].won} />
      <input min="0" autocomplete="off" class="field normal" type="number" bind:value={extraMan[side][4].lost} />
